...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('status_mahasiswa', function (Blueprint $table) {
            ...
            $table->foreignId('id_status_akademik')->constrained('status_akademik')->restrictOnDelete()->cascadeOnUpdate();
            ...
            $table->unique(['id_mahasiswa', 'id_semester'],'status_mahasiswa_unique');
        });
    }
