                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-semibold text-neutral-900 bg-neutral-200 border border-neutral-300 cursor-default leading-5 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">{{ $page }}</span>
                                            </span>
                                        @else
