@section('title', 'Import KRS — ' . config('app.name'))
@section('header_title', 'Import KRS')
@section('header_subtitle', 'Import data KRS mahasiswa secara massal dari file Excel')
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            ...
            <li>NIM dan Kode Mata Kuliah harus sudah ada di sistem, dan mata kuliah itu harus punya kelas pada semester yang dituju.</li>
            <li>Kode Semester opsional — kalau dikosongkan, dipakai semester yang sedang aktif.</li>
            <li>Status opsional (pending/acc, default pending). Status "acc" langsung menandai KRS sebagai disetujui.</li>
            <li>Kombinasi NIM + kelas yang sudah punya KRS akan dilewati (tidak dibuat ulang).</li>
