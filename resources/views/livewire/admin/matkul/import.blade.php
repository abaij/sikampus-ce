@section('title', 'Import Mata Kuliah — ' . config('app.name'))
@section('header_title', 'Import Mata Kuliah')
@section('header_subtitle', 'Import data mata kuliah secara massal dari file Excel')
...
@section('page_actions')
    <a
        href="{{ route('admin.akademik.matkul') }}"
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            ...
            <li>Kode Prodi dan Kode Jenis Mata Kuliah dicocokkan lewat kode masing-masing — kalau tidak diisi atau tidak ditemukan (khusus jenis MK), kolom itu disimpan kosong.</li>
            <li>Kode mata kuliah unik per prodi — kode yang sama boleh dipakai ulang untuk prodi yang berbeda, tapi tidak untuk prodi yang sama (baik yang sudah ada di sistem maupun duplikat dalam file).</li>
            <li>Status opsional (active/inactive, default active).</li>
