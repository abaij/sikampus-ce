@section('title', 'Import Kelas — ' . config('app.name'))
@section('header_title', 'Import Kelas')
@section('header_subtitle', 'Import data kelas kuliah secara massal dari file Excel')
...
@section('page_actions')
    <a
        href="{{ route('admin.akademik.kelas') }}"
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            <li>Download template Excel lewat tombol "Download Template" di atas — sheet "Petunjuk" di dalamnya menjelaskan setiap kolom.</li>
            <li>Isi data mengikuti kolom pada baris pertama sheet "Data" — kolom bertanda <span class="font-semibold">*</span> wajib diisi.</li>
            <li>Kode Prodi, Kode Kurikulum, dan Kode Mata Kuliah harus sudah ada di sistem dan saling berkaitan (mata kuliah harus terdaftar pada kurikulum tersebut).</li>
            <li>Kode Semester (berjalan) harus sama dengan kode di master Semester (mis. 20241) — Kode Angkatan boleh dikosongkan kalau sama dengan semester berjalan.</li>
            <li>Kode Dosen PIC dan Tim Dosen (dipisah koma) dicocokkan lewat kode dosen; Nama Kelas Mahasiswa dicocokkan lewat nama kelompok kelas.</li>
            <li>Kelas dengan kombinasi mata kuliah kurikulum, semester, angkatan, dan kelas mahasiswa yang sama persis akan dilewati (dianggap sudah ada).</li>
            <li>File lama berformat 6 kolom (Kode Matkul, Kode Prodi, Kode Semester, Kode Dosen PIC, Nama Kelas Mahasiswa, Kode Angkatan) masih didukung.</li>
