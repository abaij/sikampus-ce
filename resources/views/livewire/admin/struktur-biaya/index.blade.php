...
@section('page_actions')
    @if (\App\Support\PanelAccess::can(auth()->user(), 'struktur biaya', 'create'))
        <a
                        ...
                        <tr wire:key="struktur-biaya-{{ $strukturBiaya->id }}">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="inline-flex items-center gap-1">
                                    @if (\App\Support\PanelAccess::can(auth()->user(), 'struktur biaya', 'update'))
                                        <a
                                    ...
                                    @endif
                                    @if (\App\Support\PanelAccess::can(auth()->user(), 'struktur biaya', 'delete'))
                                        <button
                                            type="button"
