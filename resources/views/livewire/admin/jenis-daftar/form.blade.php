@section('title', ($jenisDaftarId ? 'Ubah' : 'Tambah') . ' Jenis Daftar — ' . config('app.name'))
@section('header_title', ($jenisDaftarId ? 'Ubah' : 'Tambah') . ' Jenis Daftar')
...
@section('breadcrumb')
    @include('admin.partials.breadcrumb', ['items' => [
        ['label' => 'Pengaturan'],
        ['label' => 'Jenis Daftar', 'route' => route('admin.jenis-daftar.index')],
        ['label' => $jenisDaftarId ? 'Ubah' : 'Tambah'],
    ]])
@endsection
...
<div>
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('admin.jenis-daftar.index') }}" class="rounded-lg px-4 py-2.5 text-sm font-medium text-neutral-700 transition hover:bg-neutral-50 shadow-border">
                Batal
            </a>
