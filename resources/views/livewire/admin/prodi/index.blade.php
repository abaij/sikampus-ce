...
@section('page_actions')
    @if (\App\Support\PanelAccess::can(auth()->user(), 'prodi', 'create'))
        <a
                        ...
                        <tr wire:key="prodi-{{ $prodi->id }}">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="inline-flex items-center gap-1">
                                    @if (\App\Support\PanelAccess::can(auth()->user(), 'prodi', 'update'))
                                        <a
                                    ...
                                    @endif
                                    @if (\App\Support\PanelAccess::can(auth()->user(), 'prodi', 'delete'))
                                        <button
                                            type="button"
