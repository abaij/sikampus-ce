                ...
                <tbody class="divide-y divide-neutral-100">
                    @forelse ($jenjangList as $jenjang)
                        <tr wire:key="jenjang-{{ $jenjang->id }}">
                            <td class="px-4 py-3 font-medium text-neutral-900">{{ $jenjang->nama }}</td>
                            <td class="px-4 py-3 text-neutral-600">{{ $jenjang->kode ?? '—' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-10 text-center text-neutral-500">Belum ada data jenjang.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    @if ($confirmingDeleteId)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-neutral-900/40 px-4">
            <div class="w-full max-w-sm rounded-2xl bg-white p-6 shadow-border-lg">
                <h3 class="text-base font-semibold text-neutral-900">Hapus jenjang?</h3>
