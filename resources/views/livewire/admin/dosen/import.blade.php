@section('title', 'Import Dosen — ' . config('app.name'))
@section('header_title', 'Import Dosen')
@section('header_subtitle', 'Import data dosen secara massal dari file Excel')
...
@section('page_actions')
    ...
    <a
        href="{{ route('admin.administrasi.dosen.template') }}"
        class="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-medium text-neutral-700 shadow-border transition hover:bg-neutral-50"
    >
...
<div>
    <div class="mb-6 rounded-2xl bg-white p-6 shadow-border">
        ...
        <ol class="list-inside list-decimal space-y-1 text-sm text-neutral-600">
            ...
            <li>Kolom Tempat Lahir, Provinsi, Negara, dan Agama dicocokkan lewat nama — kalau tidak ditemukan, baris tetap disimpan dengan kolom itu kosong.</li>
            <li>Kode Dosen atau NIP yang sudah terdaftar (atau duplikat dalam file) membuat baris itu dilewati. Email atau NIDN yang sudah terdaftar (atau duplikat dalam file) tetap membuat dosennya, hanya kolom itu yang disimpan kosong.</li>
