...
@section('title', 'Login Superadmin — ' . config('app.name'))
    ...
    <div class="w-full max-w-md">
        <div class="mb-8 flex flex-col items-center text-center">
            <div class="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-600 text-white shadow-lg shadow-indigo-600/25">
                <i data-lucide="shield-check" class="h-8 w-8" aria-hidden="true"></i>
            </div>
            <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Panel Superadmin</h1>
            <p class="mt-2 text-sm text-slate-600">Masuk dengan akun yang memiliki role <span class="font-medium text-slate-800">superadmin</span>.</p>
        </div>
