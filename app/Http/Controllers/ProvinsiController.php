...
class ProvinsiController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $idNegara = $request->get('id_negara');
        ...
        if ($idNegara) {
            $query->where('id_negara', $idNegara);
        }
    ...
    public function show(Provinsi $provinsi): JsonResponse
    {
        $provinsi->load('negara');
    ...
    public function update(Request $request, Provinsi $provinsi): JsonResponse
    {
        $validated = $request->validate([
            'nama' => ['required', 'string', 'max:255'],
            'kode' => ['required', 'string', 'max:50'],
    ...
    public function import(Request $request): JsonResponse
    {
        ...
        try {
            foreach ($rows as $rowIndex => $row) {
                ...
                $exists = Provinsi::where('kode', $kode)->exists();
                if ($exists) {
                    $skipCount++;
